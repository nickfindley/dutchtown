...
<div class="tribe-events-details">
	<h3 class="tribe-events-single-section-title"> <?php esc_html_e( 'Event Details', 'the-events-calendar' ) ?> </h3>
	<dl>
		...
		elseif ( tribe_event_is_multiday() ) :
			...
			<dt><i class="fas fa-fw fa-calendar"></i> <?php esc_html_e( 'Start Date', 'the-events-calendar' ) ?> </dt>
			<dd>
				<abbr class="tribe-events-abbr updated published dtstart" title="<?php esc_attr_e( $start_ts ) ?>"> <?php esc_html_e( $start_datetime ) ?> </abbr>
			</dd>

			<dt><i class="fas fa-fw fa-calendar"></i> <?php esc_html_e( 'End Date', 'the-events-calendar' ) ?> </dt>
			<dd>
		...
		if ( ! empty( $website ) ) : ?>
			...
			<dd class="tribe-events-event-url"><a href="<?php echo $website; ?>"><?php echo $website_host ?></a></dd>
		<?php endif ?>
