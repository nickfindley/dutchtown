...
<ul class="tribe-related-events tribe-clearfix">
	...
	<li>
		<?php $thumb = ( has_post_thumbnail( $post->ID ) ) ? get_the_post_thumbnail( $post->ID, 'large' ) : '<img src="/wp-content/themes/dutchtown/dist/img/flag.regular.2000x1000.png' . '" alt="' . esc_attr( get_the_title( $post->ID ) ) . '" />'; ?>
		...
		<div class="tribe-related-event-info">
			...
			<?php
				if ( $post->post_type == Tribe__Events__Main::POSTTYPE ) {
					echo tribe_get_start_date( $post->ID, false, 'F jS, Y \a\t g:ia', null );
				}
			?>
		</div>
	</li>
